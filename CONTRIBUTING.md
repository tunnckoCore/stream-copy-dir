# Contributing to stream-copy-dir

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `stream-copy-dir`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `stream-copy-dir` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/stream-copy-dir/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of `stream-copy-dir`.

The [`question` label](https://github.com/tunnckoCore/stream-copy-dir/labels/question%20%2F%20discussion) is a good place to find ongoing discussions.
...
1. **version**: what version of `stream-copy-dir` were you using when you experienced the bug?
